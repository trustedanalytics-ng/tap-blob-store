...
run: change_gopath local_bin/blob-store local_bin/minio
	...
	sleep 2 &&\
	MINIO_ACCESS_KEY=access_key MINIO_SECRET_KEY=secret_key MINIO_HOST=localhost MINIO_PORT=9000 BLOB_STORE_PORT=8084 BLOB_STORE_HOST=localhost $(GOBIN)/tapng-blob-store
